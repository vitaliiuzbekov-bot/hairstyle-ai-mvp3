      ...
      if (setIsDeveloper) {
        ...
        if (window.Telegram?.WebApp?.showPopup) {
          window.Telegram.WebApp.showPopup({
            ...
            message: nextDev 
              ? "Режим разработчика активирован. Расширенная отладка включена."
